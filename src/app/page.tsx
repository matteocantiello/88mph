        ...
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="font-body text-[11px] text-foreground/10 mt-1 flex items-center gap-1.5">
              ...
              <a href="https://soundcloud.com/etrurian" target="_blank" rel="noopener noreferrer" className="text-foreground/20 hover:text-[#ff5500] transition-colors ml-0.5" aria-label="SoundCloud">
